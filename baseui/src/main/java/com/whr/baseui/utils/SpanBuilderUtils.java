 ...
 * </pre>
 */
public final class SpanBuilderUtils {
     ...
     *
     */
    public SpanBuilderUtils setFlag(final int flag) {
        this.flag = flag;
        return this;
    }
     ...
     *
     * @param color 前景色
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setForegroundColor(@ColorInt final int color) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setBackgroundColor(@ColorInt final int color) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setLineHeight(@IntRange(from = 0) final int lineHeight) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setLineHeight(@IntRange(from = 0) final int lineHeight, @Align final int align) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setQuoteColor(@ColorInt final int color) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setQuoteColor(@ColorInt final int color, @IntRange(from = 1) final int stripeWidth, @IntRange(from = 0) final int gapWidth) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setLeadingMargin(@IntRange(from = 0) final int first, @IntRange(from = 0) final int rest) {
        this.first = first;
        this.rest = rest;
        return this;
    }
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setBullet(@IntRange(from = 0) final int gapWidth) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setBullet(@ColorInt final int color, @IntRange(from = 0) final int radius, @IntRange(from = 0) final int gapWidth) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setIconMargin(final Bitmap bitmap) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setIconMargin(final Bitmap bitmap, final int gapWidth, @Align final int align) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setIconMargin(final Drawable drawable) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setIconMargin(final Drawable drawable, final int gapWidth, @Align final int align) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setIconMargin(final Uri uri) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setIconMargin(final Uri uri, final int gapWidth, @Align final int align) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setIconMargin(@DrawableRes final int resourceId) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setIconMargin(@DrawableRes final int resourceId, final int gapWidth, @Align final int align) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setFontSize(@IntRange(from = 0) final int size) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setFontSize(@IntRange(from = 0) final int size, final boolean isDp) {
        this.fontSize = size;
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setFontProportion(@FloatRange(from = 0, fromInclusive = false) final float proportion) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setFontXProportion(@FloatRange(from = 0, fromInclusive = false) final float proportion) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setStrikethrough() {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setUnderline() {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setSuperscript() {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setSubscript() {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setBold() {
        isBold = true;
        return this;
    }
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setItalic() {
        isItalic = true;
        return this;
    }
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setBoldItalic() {
        isBoldItalic = true;
        return this;
    }
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setFontFamily(@NonNull final String fontFamily) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setTypeface(@NonNull final Typeface typeface) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setAlign(@NonNull final Alignment alignment) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setClickSpan(@NonNull final ClickableSpan clickSpan) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setUrl(@NonNull final String url) {
        this.url = url;
        return this;
    }
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius, final Blur style) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setShader(@NonNull final Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
                                                                         final float dx,
                                                                         final float dy,
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils setSpans(@NonNull final Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils append(CharSequence text) {
        if (text==null)
            text = "";
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils appendLine() {
        apply(mTypeCharSequence);
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils appendLine(@NonNull final CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils appendImage(@NonNull final Bitmap bitmap) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils appendImage(@NonNull final Bitmap bitmap, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils appendImage(@NonNull final Drawable drawable) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils appendImage(@NonNull final Uri uri) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils appendImage(@NonNull final Uri uri, @Align final int align) {
        apply(mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils appendImage(@DrawableRes final int resourceId) {
        return appendImage(resourceId, ALIGN_CENTER);
    }
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils appendImage(@DrawableRes final int resourceId, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils appendSpace(@IntRange(from = 0) final int size) {
     ...
     * @return {@link SpanBuilderUtils}
     */
    public SpanBuilderUtils appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
    ...
    class CustomIconMarginSpan implements LeadingMarginSpan, android.text.style.LineHeightSpan {
        ...
        private Bitmap uri2Bitmap(final Uri uri) {
            try {
                return MediaStore.Images.Media.getBitmap(UiCoreHelper.Companion.getProxy().getContext().getContentResolver(), uri);
            } catch (IOException e) {
                e.printStackTrace();
        ...
        private Bitmap resource2Bitmap(final int resourceId) {
            Drawable drawable = ContextCompat.getDrawable(UiCoreHelper.Companion.getProxy().getContext(), resourceId);
    ...
    class UrlImageSpan extends CustomDynamicDrawableSpan {
        private Drawable mDrawable;
        private String mResourseUrl;

        private UrlImageSpan(final String b, final int verticalAlignment) {
        ...
        public Drawable getDrawable() {
            Glide.with(UiCoreHelper.Companion.getProxy().getContext())
                    .asBitmap()
                    .load(url)
                    .into(new SimpleTarget<Bitmap>() {
                        @Override
                        public void onResourceReady(@NonNull Bitmap resource, @Nullable Transition<? super Bitmap> transition) {
                            BitmapDrawable b = new BitmapDrawable(resource);
    ...
    class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Bitmap b, final int verticalAlignment) {
            super(verticalAlignment);
            mDrawable = new BitmapDrawable(UiCoreHelper.Companion.getProxy().getContext().getResources(), b);
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                Bitmap bitmap;
                try {
                    InputStream is = UiCoreHelper.Companion.getProxy().getContext().getContentResolver().openInputStream(mContentUri);
                    bitmap = BitmapFactory.decodeStream(is);
                    drawable = new BitmapDrawable(UiCoreHelper.Companion.getProxy().getContext().getResources(), bitmap);
                    drawable.setBounds(0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
                    if (is != null) {
                        is.close();
                    }
                ...
                try {
                    drawable = ContextCompat.getDrawable(UiCoreHelper.Companion.getProxy().getContext(), mResourceId);
                    drawable.setBounds(0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
                } catch (Exception e) {
