...
public final class SizeUtils {
    ...
    public static int dp2px(final float dpValue) {
        final float scale =  UiCoreHelper.Companion.getProxyA().getContext().getResources().getDisplayMetrics().density;
    ...
    public static int sp2px(final float spValue) {
        final float fontScale = UiCoreHelper.Companion.getProxyA().getContext().getResources().getDisplayMetrics().scaledDensity;
