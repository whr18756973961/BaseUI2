...
/**
 * Created by qijia on 2017/10/12.
 */
...
public class ClearableEditText extends AppCompatEditText {
    ...
    //标识当前是否展示清除按钮
    private boolean isShowClearView = true;
    ...
    private void init() {
        mClearDrawable = getResources().getDrawable(R.mipmap.ic_et_clear);
    }
    public boolean isShowClearView() {
        return isShowClearView;
    }

    public void setShowClearView(boolean showClearView) {
        isShowClearView = showClearView;
    }
