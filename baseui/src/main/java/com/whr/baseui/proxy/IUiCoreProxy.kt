...
abstract class IUiCoreProxy {
    ...
    open var lifeCycle: Activitylifecycle? = null

    fun setLifeCycleListener(lifeCycle: Activitylifecycle) {
        this.lifeCycle = lifeCycle
    }

    fun removeLifeCycleListener() {
        this.lifeCycle = null
    }
     ...
     * @param activity
     */
    open fun onActivityCreate(activity: Activity) {
     ...
     * @param activity
     */
    open fun onActivityStart(activity: Activity) {}
     ...
     * @param activity
     */
    open fun onActivityRestart(activity: Activity) {}
     ...
     * @param activity
     */
    open fun onActivityResume(activity: Activity) {}
     ...
     * @param activity
     */
    open fun onActivityPause(activity: Activity) {}
     ...
     * @param activity
     */
    open fun onActivityStop(activity: Activity) {}
     ...
     * @param activity
     */
    open fun onActivityDestory(activity: Activity) {}
     ...
     * @param fragment
     */
    open fun onFragmentCreate(fragment: Fragment) {}
     ...
     * @param fragment
     */
    open fun onFragmentCreateView(fragment: Fragment) {}
     ...
     * @param fragment
     */
    open fun onFragmentActivityCreated(fragment: Fragment) {}
     ...
     * @param fragment
     */
    open fun onFragmentStart(fragment: Fragment) {}
     ...
     * @param fragment
     */
    open fun onFragmentResume(fragment: Fragment) {}
     ...
     * @param fragment
     */
    open fun onFragmentPause(fragment: Fragment) {}
     ...
     * @param fragment
     */
    open fun onFragmentStop(fragment: Fragment) {}
     ...
     * @param fragment
     */
    open fun onFragmentDestroyView(fragment: Fragment) {}
     ...
     * @param fragment
     */
    open fun onFragmentDestroy(fragment: Fragment) {}
     ...
     * @param fragment
     */
    open fun onFragmentDetach(fragment: Fragment) {}
